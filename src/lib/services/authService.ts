...
export class AuthService {
  ...
  public login(phone:String, password:String) {
    ...
    return this.http.post(this._apiEndpoint + 'api-token-auth/', body, {headers: myHeader})
      ...
      .do(res => {
        ...
        this._requestService.alertWatchers();
      });
  }
  ...
  public update(user:User) {
    ...
    return this._requestService.request('PUT', this._apiEndpoint + user.id + '/', key, copy)
      .do(res => {
        this._requestService.alertWatchers();
      })
      .map(res => <User> res.json());
  ...
  public validateCode(code:string) {
    var data = {code:code};
    return this._requestService.request('POST', this._apiEndpoint + 'verify-auth-code/', null, data);
  }
